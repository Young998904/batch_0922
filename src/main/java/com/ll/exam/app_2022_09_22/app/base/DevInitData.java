...
public class DevInitData {
    ...
    public CommandLineRunner initData(MemberService memberService , ProductService productService, CartService cartService) {
        return args ->
        {
            ...
            ProductOption productOption__RED_44 = product1.getProductOptions().get(0); // 상품 1 의 RED_44 옵션
            ProductOption productOption__BLUE_44 = product1.getProductOptions().get(2); // 상품 1 의 BLUE_44 옵션
